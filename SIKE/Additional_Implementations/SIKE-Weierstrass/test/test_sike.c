...
int test_sidh(const char* name, const sike_params_t* params) {
  ...
  weier_curve_init(p, &publicKey_A);
  weier_curve_init(p, &publicKey_B);


  sidh_sk_keygen(params, ALICE, privateKey_A);
  sidh_isogen(params, &publicKey_A, privateKey_A, ALICE);

  printFp2("pkA.Px = ", &publicKey_A.P.x);
  printFp2("pkA.Py = ", &publicKey_A.P.y);
  printFp2("pkA.Qx = ", &publicKey_A.Q.x);
  printFp2("pkA.Qy = ", &publicKey_A.Q.y);

  sidh_sk_keygen(params, BOB, privateKey_B);
  sidh_isogen(params, &publicKey_B, privateKey_B, BOB);

  printFp2("pkB.Px = ", &publicKey_B.P.x);
  printFp2("pkB.Py = ", &publicKey_B.P.y);
  printFp2("pkB.Qx = ", &publicKey_B.Q.x);
  printFp2("pkB.Qy = ", &publicKey_B.Q.y);
  ...
  weier_curve_clear(p, &publicKey_A);
  weier_curve_clear(p, &publicKey_B);
...
int test_pke(const char* name, const sike_params_t* params) {
  ...
  weier_curve_init(p, &c0);
  weier_curve_init(p, &pk3);
  ...
  weier_curve_clear(p, &c0);
  weier_curve_clear(p, &pk3);
