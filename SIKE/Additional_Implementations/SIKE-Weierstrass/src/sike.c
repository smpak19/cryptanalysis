...
/**
 * Function h: cSHAKE with parameter cshake_H
 */
 ...
 * @return
 */
int sike_pke_enc(const sike_params_t* params, const sike_public_key_t* pk3, const sike_msg* m, const sike_private_key sk2, sike_public_key_t* c0, unsigned char* c1 )
{
 ...
 * @return
 */
int sike_pke_dec(const sike_params_t* params, const sike_private_key sk3, const sike_public_key_t* c0, const unsigned char* c1, sike_msg* m)
{
 ...
 * @return
 */
int sike_kem_encaps(const sike_params_t *params,
 ...
 * @return
 */
int sike_kem_decaps(const sike_params_t *params,
                    const sike_public_key_t *pk3,
